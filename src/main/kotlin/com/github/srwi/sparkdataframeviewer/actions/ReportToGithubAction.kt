...
class ReportToGithubAction(text: String, private val exceptionText: String) : NotificationAction(text) {
    override fun actionPerformed(e: AnActionEvent, notification: Notification) {
        val baseUrl = "https://github.com/srwi/PyCharm-SparkDataFrameViewer/issues/new"

        val plugin = PluginManagerCore.getPlugin(PluginId.getId("com.github.srwi.sparkdataframeviewer"))
