package com.github.srwi.sparkdataframeviewer.listeners

import com.github.srwi.sparkdataframeviewer.UserSettings
import com.github.srwi.sparkdataframeviewer.icons.DataFrameViewerIcons
...
internal class PluginActivationListener : ApplicationActivationListener {
    ...
    private fun showRateNotification() {
        val notification = ExpandedNotification(
            ...
            "Thank you for using Spark DataFrame Viewer!",
            "<p style=\"padding-bottom: 10px\">It's been over a month since you began using Spark DataFrame Viewer. If you're enjoying it, I'd be truly grateful for your support.</p>" +
        ...
        notification.addAction(NotificationAction.createSimple("Star on GitHub") {
            val url = "https://github.com/srwi/PyCharm-SparkDataFrameViewer"
            Desktop.getDesktop().browse(URI(url))
        })
        ...
        notification.icon = DataFrameViewerIcons.Heart
